...
export interface CategoryCardData {
  ...
  children?: { name: string; slug: string; listing_count?: number }[];
}
...
function CategoryIcon({ icon, className = 'w-4 h-4' }: { icon: string | null | undefined; className?: string }) {
  const resolved = icon ? (ICON_MAP[icon.toLowerCase()] || icon.toUpperCase()) : 'BOOK';

  const props = { className, fill: 'none' as const, viewBox: '0 0 24 24', stroke: 'currentColor', strokeWidth: 1.5 };
  ...
  switch (resolved) {
    ...
    case 'CAMERA':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0z" /></svg>;
    case 'BRIEFCASE':
    ...
    case 'MAP':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m0-8.25a1.5 1.5 0 010 3m0-3a1.5 1.5 0 000 3m0 9.75V15m0 0a1.5 1.5 0 110 3m0-3a1.5 1.5 0 100 3m-3.375 0h10.5a1.5 1.5 0 001.5-1.5V5.625a1.5 1.5 0 00-1.5-1.5H5.625a1.5 1.5 0 00-1.5 1.5v12.75a1.5 1.5 0 001.5 1.5z" /></svg>;
    case 'PEOPLE':
    ...
    case 'SHOPPING':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" /></svg>;
    case 'MUSIC':
      return <svg {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 11-.99-3.467l2.31-.66a2.25 2.25 0 001.632-2.163zm0 0V2.25L9 5.25v10.303m0 0v3.75a2.25 2.25 0 01-1.632 2.163l-1.32.377a1.803 1.803 0 01-.99-3.467l2.31-.66A2.25 2.25 0 009 15.553z" /></svg>;
    case 'HEART':
...
export function CategoryGrid({ categories, basePath, emptyMessage, slugTransform }: CategoryGridProps) {
  if (categories.length === 0) {
    return (
      <div className="text-center py-16">
        <p className="text-gray-500">{emptyMessage || 'No categories available yet. Check back soon!'}</p>
      </div>
    );
  }
