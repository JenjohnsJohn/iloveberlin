...
export default async function EventDetailPage({
  ...
  // Validate category segment matches event's actual category
  const actualCategorySlug = event.category?.slug || null;
  const expectedCategorySegment = toEventCategorySeoSlug(actualCategorySlug || 'general');
  if (category !== expectedCategorySegment) {
    permanentRedirect(buildEventUrl(slug, actualCategorySlug));
  }
